...
<table class="table" align="center">
	<tr style="background: #4682B4;">
		<td colspan="2" align="center"  height="68px" >
			<iframe frameborder="0" src="<c:url value='/jsps/top.jsp'/>" name="top"></iframe>
		</td>
	</tr>
	<tr>
		<td width="160" style="padding:5px;" align="center" valign="top">
			<iframe frameborder="0" width="120" src="<c:url value='/CategoryServlet?method=findAll'/>" name="left"></iframe>
		</td>
		<td>
			<iframe frameborder="0" src="<c:url value='/BookServlet?method=findAll'/>" name="body"></iframe>
		</td>
	</tr>
</table>
  </body>
